        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-danger position-sticky"
                ...
                <div className="container-fluid">
                    <Link className="navbar-brand fs-3 text" to="/">Fast-F😋😋D</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-5">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link fs-5 mx-3 active" aria-current="page" to="/contact">Contact Us</Link>
                            </li>
                        ...
                        {(!localStorage.getItem("token")) ?
                            <form className="d-flex">
                                ...
                                <Link className="btn bg-warning text-white mx-1" to="/signup">Signup</Link>
                            </form> :
                            <div>
                                ...
                                <button onClick={handleLogout} className="btn bg-warning text-white mx-1" >Logout</button></div>}
                    </div>
                </div>
            </nav>
        </div>
